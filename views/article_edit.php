...
<div class="container mx-auto px-4 py-8 max-w-2xl">
  ...
  <form action="?page=article_edit&action=update_article" method="POST" enctype="multipart/form-data" class="space-y-4">
    <div>
    ...
    <div>
      ...
      <textarea name="content" rows="2"
        class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"><?= htmlspecialchars($article['body']) ?></textarea>
    </div>
